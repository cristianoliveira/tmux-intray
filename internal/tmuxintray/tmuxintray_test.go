...
func TestAddNotification(t *testing.T) {
	setupTest(t)
	Init()
	id := AddNotification("test message", "", "", "", "", false, "info")
...
func TestDismissAllNotifications(t *testing.T) {
	setupTest(t)
	Init()
	AddNotification("msg1", "", "", "", "", false, "info")
	AddNotification("msg2", "", "", "", "", false, "warning")
...
func TestCleanupOldNotifications(t *testing.T) {
	...
	id := AddNotification("old", "", "", "", "", false, "info")
	require.NotEmpty(t, id)
	err := DismissNotification(id)
	require.NoError(t, err)
...
func TestGetActiveCount(t *testing.T) {
	...
	// Dismiss one
	id := AddNotification("msg3", "", "", "", "", false, "info")
