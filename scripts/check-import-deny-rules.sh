...
detect_layer() {
    ...
    "$module_path/cmd" | "$module_path/cmd/"*)
        printf 'cli\n'
        ;;
    "$module_path/internal/tui" | "$module_path/internal/tui/"* | "$module_path/internal/format" | "$module_path/internal/formatter" | "$module_path/internal/formatter/"* | "$module_path/internal/status")
        printf 'presentation\n'
        ;;
